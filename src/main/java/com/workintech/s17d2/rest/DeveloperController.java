...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1, new JuniorDeveloper(1, "şevval", 1000d ));
    }
    @PostMapping
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if(foundDeveloper== null){
            return new DeveloperResponse(null, HttpStatus.FOUND.value(), id + " ile search yapıldığında kayıt bulunamadı");
        }
